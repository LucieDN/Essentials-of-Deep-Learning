function [X,Y,Mval,savecost] = net_2_5_5_5_2_relu(m, n, x1, x2, y, eta, Niter)
    ...
    for counter = 1:Niter
        ...
        % Backward pass
        delta5 = (a5 > 0).*(a5-y(:,k));
        delta4 = (a4 > 0).*(W5'*delta5);
        delta3 = (a3 > 0).*(W4'*delta4);
        delta2 = (a2 > 0).*(W3'*delta3);
        % Gradient step
        W2 = W2 - eta*delta2*x';
        W3 = W3 - eta*delta3*a2';
        W4 = W4 - eta*delta4*a3';
    ...
    show_training_results(m, n, x1, x2, X, Y, Mval, savecost, Niter, "(2\rightarrow5\rightarrow5\rightarrow5\rightarrow2) with relu training results");

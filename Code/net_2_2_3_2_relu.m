function [X,Y,Mval,savecost] = net_2_2_3_2_relu(m, n, x1, x2, y, eta, Niter)
    ...
    show_training_results(m, n, x1, x2, X, Y, Mval, savecost, Niter, "(2\rightarrow2\rightarrow3\rightarrow2) with relu training results");
